...
const checkoutAgainBtns = document.querySelectorAll(".checkout-again-btn");
...
checkoutAgainBtns.forEach((checkoutAgainBtn) => {
  checkoutAgainBtn.addEventListener("click", async () => {
    const orderId =
      checkoutAgainBtn.dataset.orderId;
...
const clearReviewErrors = () => {
  ...
  reviewComment?.classList.remove(
